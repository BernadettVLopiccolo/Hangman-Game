...
document.onkeyup = function(event) {
    ...
    //fix this part
    for (var l = 0; l <= compWordsArray.length; l++) {
        blankWordsArray[i] = " _ ";
        if (userGuess === compWordsArray[l]) {
            ...
            console.log('blankWordsArray', blankWordsArray);
    ...
    console.log('blankWordsArray2', blankWordsArray);
    
    for (var j = 0; j < blankWordsArray.length; j++) {
        document.getElementById("blanks").innerHTML += blankWordsArray[i];
    }
